...
describe('[Exercise 7] isEvenNumberAsync', () => {
  test('[19] resolves true if passed an even number', async () => {
    const checkingEven = await utils.isEvenNumberAsync(2)
    expect(checkingEven).toBeTruthy()
  })
  test('[20] resolves false if passed an odd number', async () => {
    const checkingOdd = await utils.isEvenNumberAsync(3)
    expect(checkingOdd).toBeFalsy()
  })
})
